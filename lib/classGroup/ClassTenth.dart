...
import 'package:timetableappforteachers/classGroup/ClassEighth.dart';
import 'package:timetableappforteachers/classGroup/ClassNinth.dart';
import 'package:timetableappforteachers/classGroup/ClassSeventh.dart';
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Container(margin:EdgeInsets.all(10),padding: EdgeInsets.symmetric(horizontal: 15),child: Text('',style: TextStyle(color:Colors.white,fontSize:20))),
                  ...
                  Container(margin:EdgeInsets.all(10),padding: EdgeInsets.all(5),child: Text('Wed',style: TextStyle(color:Colors.white,fontSize:20))),
                  Container(margin:EdgeInsets.all(10),padding: EdgeInsets.all(5),child: Text('Thu',style: TextStyle(color:Colors.white,fontSize:20))),
                  Container(margin:EdgeInsets.all(10),padding: EdgeInsets.all(5),child: Text('Fri',style: TextStyle(color:Colors.white,fontSize:20))),
                ],
              ),
              GridView(
